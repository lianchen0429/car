...
<body>
	<?php
		include ("adminmenu.php");
			$str = "SELECT DISTINCT `使用者_帳號` FROM `訂單`"; 
	...
	<div class="container">
      ...
      <div class="row">
        <form class="form-horizontal" name="action" method="post" action="thing_of_members2.php">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              ...
              ?>
                <option><?php echo $row_member["使用者_帳號"];?></option>
		      <?php } ?>
              </select>
            </div>
          </div>
