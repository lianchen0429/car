...
<body>
	...
	<div class="container">
      ...
      <div class="row">
        <form class="form-horizontal" name="action" method="post" action="database/delect_thing.php">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="email" class="form-control"  value="<?= $data['商品單價'] ?>" placeholder="電子郵件" readonly>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label">庫存量</label>
            <div class="col-sm-10">
              <input type="text" name="phone" class="form-control"  value="<?= $data['庫存量'] ?>" placeholder="地址" readonly>
            </div>
          </div>
          <div class="form-group">
